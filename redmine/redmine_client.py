...
#       OBTENGO INFORMACION RESPONSABLE FIRMA
        ...
        logging.info(f"redmine_client.py - email_responsable: {email_responsable}")
        ...
        if not email_responsable or not rut_responsable or not nombre_responsable:
            logging.info(f"redmine_client.py - email_responsable: {email_responsable} no encontrado.")
